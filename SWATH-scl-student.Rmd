...
146 were identified and quantified. 
...
A protein is considered differentially expressed if it's p.value and fold change are superior to a determined threshold.
...
Volcano Plots are the best way to visualise the pvalue and the fold change at the same time. Here the Volcano pllots are generated in a loop from the results list.
